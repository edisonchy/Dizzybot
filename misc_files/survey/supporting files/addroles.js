module.exports.addRoles = (list, interaction) => {
  ...
  const 樂富黃大仙慈雲山 =
    interaction.guild.roles.cache.get("942656066188115969");
  ...
  const SkateBeginner = interaction.guild.roles.cache.get(
    "1048670387061407815"
  );
  const SkateIntermediate = interaction.guild.roles.cache.get(
    "1048670204357521489"
  );
  const SkateAdvanced = interaction.guild.roles.cache.get(
    "1048670383089393784"
  );
  const SnowBeginner = interaction.guild.roles.cache.get("1048670359383183480");
  const SnowIntermediate = interaction.guild.roles.cache.get(
    "1048674580597833779"
  );
  ...
  const SurfIntermediate = interaction.guild.roles.cache.get(
    "1048674633680957630"
  );
  const SurfAdvanced = interaction.guild.roles.cache.get("1088703737415082065");

  interaction.member.roles.add(已介紹);

  for (let i = 0; i < list.length; i++) {
    if (list[i] == "港島東") {
      interaction.member.roles.add(港島東);
    } else if (list[i] == "港島南區") {
      interaction.member.roles.add(港島南區);
    } else if (list[i] == "港島西") {
      interaction.member.roles.add(港島西);
    } else if (list[i] == "大西北") {
      interaction.member.roles.add(大西北);
    } else if (list[i] == "將軍澳") {
      interaction.member.roles.add(將軍澳);
    } else if (list[i] == "上水粉領") {
      interaction.member.roles.add(上水粉領);
    } else if (list[i] == "明日大愚") {
      interaction.member.roles.add(明日大愚);
    } else if (list[i] == "貨櫃碼頭") {
      interaction.member.roles.add(貨櫃碼頭);
    } else if (list[i] == "油尖旺") {
      interaction.member.roles.add(油尖旺);
    } else if (list[i] == "美孚至深水埗") {
      interaction.member.roles.add(美孚至深水埗);
    } else if (list[i] == "紅磡土瓜灣") {
      interaction.member.roles.add(紅磡土瓜灣);
    } else if (list[i] == "樂富黃大仙慈雲山") {
      interaction.member.roles.add(樂富黃大仙慈雲山);
    } else if (list[i] == "觀塘九龍灣") {
      interaction.member.roles.add(觀塘九龍灣);
    } else if (list[i] == "沙田馬鞍山") {
      interaction.member.roles.add(沙田馬鞍山);
    } else if (list[i] == "大埔馬料水") {
      interaction.member.roles.add(大埔馬料水);
    } else if (list[i] == "UK幫") {
      interaction.member.roles.add(UK幫);
    } else if (list[i] == "JP幫") {
      interaction.member.roles.add(JP幫);
    } else if (list[i] == "台灣幫") {
      interaction.member.roles.add(台灣幫);
    } else if (list[i] == "澳洲幫") {
      interaction.member.roles.add(澳洲幫);
    } else if (list[i] == "skateBeginner") {
      interaction.member.roles.add(SkateBeginner);
    } else if (list[i] == "skateIntermediate") {
      interaction.member.roles.add(SkateIntermediate);
    } else if (list[i] == "skateAdvanced") {
      interaction.member.roles.add(SkateAdvanced);
    } else if (list[i] == "snowBeginner") {
      interaction.member.roles.add(SnowBeginner);
    } else if (list[i] == "snowIntermediate") {
      interaction.member.roles.add(SnowIntermediate);
    } else if (list[i] == "snowAdvanced") {
      interaction.member.roles.add(SnowAdvanced);
    } else if (list[i] == "surfIntermediate") {
      interaction.member.roles.add(SurfIntermediate);
    } else if (list[i] == "surfBeginner") {
      interaction.member.roles.add(SurfBeginner);
    } else if (list[i] == "surfAdvanced") {
      interaction.member.roles.add(SurfAdvanced);
    }
  }
};
